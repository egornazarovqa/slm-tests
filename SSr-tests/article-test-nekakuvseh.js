...
describe("ne kak u vseh test", function() {
    //timeout
    this.timeout(30000);
    //headless
    let driver;
    ...
    //mocha it для ne kak u vseh
    it("Ne kak u vseh article test", async function() {

        //открыть страницу статьи
        await driver.get('https://www.salonsecret.ru/strizhki/trendy/asimmetrichnaya-chelka');
        ...
        assert.strictEqual(headerText, "НЕ КАК У ВСЕХ: АСИММЕТРИЧНАЯ ЧЕЛКА");
