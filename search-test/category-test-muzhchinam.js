...
describe("muzhchinam test", function() {
    //timeout
    this.timeout(30000);
    //headless
    let driver;
    ...
    //mocha it для muzhchinam
    it("muzhchinam category test", async function() {

        //открыть страницу категории
        await driver.get('https://www.salonsecret.ru/muzhchinam');
        ...
        assert.strictEqual(headerText, "МУЖЧИНАМ");
