...
describe("search test", function () {
    ...
    //mocha it для Stevie
    it("Stevie search Ирокез", async function () {
        ...
        await searchfield.sendKeys("ирокез", Key.RETURN);

        //проверить результат
        const resultXPath = '//div[contains(@class, "LinesEllipsis") and contains(normalize-space(.), "Женский ирокез")]';
        ...
        assert.strictEqual(searchresult, "Женский ирокез для образа панк-дивы");
