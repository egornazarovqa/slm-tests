...
describe("HAIRоскоп test", function() {
    //timeout
    this.timeout(30000);
    //headless
    let driver;
    ...
    //mocha it для HAIRоскоп
    it("HAIRоскоп category test", async function() {

        //открыть страницу категории
        await driver.get('https://www.salonsecret.ru/hairoskop');
        ...
        assert.strictEqual(headerText, "HAIROСКОП");
